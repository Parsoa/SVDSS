...
### Note: for SVDSS (v1, conda version), please refer to [v1.0.5-fix](https://github.com/Parsoa/SVDSS/releases/tag/v1.0.5-fix) and [6fa89f0](https://github.com/Parsoa/SVDSS/tree/6fa89f0a4f8ec03ab87c3eb8a3288a6b82214767). This is the v2 README. SVDSS2 should be ready for release, so feel free to use the new version. We just want to test it a bit more before officially releasing it.
