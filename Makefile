...
PARASAIL_PREFIX=./lib/parasail
LIBDEFLATE_PREFIX=./libdeflate
CXX=g++
CXXFLAGS=-std=c++14 -Wall -Wno-comment -O3 -I$(ROPE_PREFIX) -I$(RF_PREFIX) -I$(HTS_PREFIX) -I$(ABPOA_PREFIX)/include -I$(PARASAIL_PREFIX)/include -I$(KSW_PREFIX) -I$(INTTREE_PREFIX) -fopenmp -Wno-sign-compare -Wno-unused-variable
LIBS=-L$(HTS_PREFIX) -L$(ABPOA_PREFIX)/lib -L$(LIBDEFLATE_PREFIX) -L$(LIBDEFLATE_PREFIX)/lib -ldeflate -L$(PARASAIL_PREFIX)/lib -lparasail -lm -lpthread -lz -lhts -labpoa
