...
/share/hormozdiarilab/Codes/Stella/lib/bbmap/bbmap.sh threads=36 k=11 ambiguous=all usequality=f idtag=t ref=../child/alt.fa path=./bbmap in=solution_aggregated.short.fastq outm=solution.aggregated.short.sam
