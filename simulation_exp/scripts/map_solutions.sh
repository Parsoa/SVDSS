...
/share/hormozdiarilab/Codes/Stella/lib/bbmap/bbmap.sh threads=8 k=11 usequality=f idtag=t ref=$PWD/alt.fa path=./bbmap in=solution_aggregated.short.fastq outm=solution.aggregated.short.sam
