...
def plot_abundance():
    ...
    dplot = sns.displot(df, x="Abundances", hue="Strings", fill=True, legend=False)
...
def plot_nal_by_err():
    ...
    data1 = []
    #for bampath1 in ["short.sorted.bam", "long.bam"]:
    ...
    data2 = []
    #for bampath2 in ["short.mother.sorted.bam", "long.mother.bam"]:
    ...
    data3 = []
    #for bampath3 in ["short.father.sorted.bam", "long.father.bam"]:
    ...
    nbins = 7
    fig, (ax1, ax2, ax3) = plt.subplots(1, 3, sharey = True, tight_layout=True, figsize=(13, 7))
    ...
    ax3.legend(loc=4, fancybox=True, shadow=True)
